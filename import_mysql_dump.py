...
db_path = 'instance/contentplan.db'
sql_dump_path = 'contentplan_dump.sql'

if not os.path.exists(db_path):
    print("Error: SQLite database does not exist. Run the Flask app once first.")
    exit(1)
...
print(f"\n[OK] Migrasi selesai! Berhasil memasukkan {insert_count} query data ke SQLite.")
